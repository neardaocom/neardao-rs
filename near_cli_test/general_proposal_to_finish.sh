...
PUUID=$(near call $DCID add_proposal '{"proposal_input" : {"description": "Pandas are cute.", "tags":["test","panda","fluffy"], "transaction": { "GeneralProposal": {"title": "Share your opinion"} }}}' --amount 0.5 --gas 100000000000000 --accountId $CID4 | tail -n1 | tr -d '[:space:]')
