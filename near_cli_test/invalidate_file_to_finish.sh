...
PUUID=$(near call $DCID add_proposal '{"proposal_input" : {"description": "This file is not valid anymore.", "tags":["test","invalidate"], "transaction": { "InvalidateFile": {"uuid": "5fb2ae525103eb24bb18d10779426660"} }}}' --amount 1 --gas 100000000000000 --accountId $CID4 | tail -n1 | tr -d '[:space:]')
