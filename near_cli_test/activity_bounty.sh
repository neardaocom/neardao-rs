...
# 4. activity
CODE_4='done'
ARGS_4='[{"String":"heres some link"}]'

# 5. activity
CODE_5='done_approve'
ARGS_5='[{"String":"All good - 5/5"}]'

CODE=$CODE_1
ARGS=$ARGS_1

#near call $DCID event '{"proposal_id":2,"code":"'$CODE'","args":'$ARGS'}' --deposit $DEPOSIT --accountId $CID1 --gas $TGAS_200
near call $DCID treasury_send_near '{"proposal_id":2,"receiver_id":"'$CID1'","amount":"5000000000000000000000000"}' --accountId $CID1 --gas $TGAS_100
