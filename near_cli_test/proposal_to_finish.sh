...
PUUID=$(near call $DCID add_proposal '{"proposal_input" : {"description": "I need NEAR TOKENS, bros.", "tags":["test","first","money"],  "description_cid": null}, "tx_input": { "Pay": {"amount_near": "40000000000000000000000000", "account_id":"'$CID4'"} }}' --amount $DEPOSIT_ADD_PROPOSAL --gas $TGAS_100 --accountId $CID4 | tail -n1 | tr -d '[:space:]')
