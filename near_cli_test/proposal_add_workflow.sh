...
S_PROPOSE_SETTINGS='{"activity_inputs":[[["Free"]]],"transition_constraints":[[{"transition_limit":1,"cond":null}],[{"transition_limit":0,"cond":null}]],"binds":[],"obj_validators":[[]],"validator_exprs":[],"storage_key":"wf_add_wf_1"}'
