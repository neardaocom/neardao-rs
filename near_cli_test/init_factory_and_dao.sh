...
#near view $DCID storage_data '{"bucket_id": "workflow", "data_id": "action_1_result"}'
#near view $DCID storage_data '{"bucket_id": "workflow", "data_id": "action_2_result"}'
#near view $DCID storage_data '{"bucket_id": "workflow", "data_id": "action_3_result"}'
#near view $DCID storage_bucket_all '{"bucket_id": "workflow"}'
#near view $DCID storage_data_as_string '{"bucket_id": "workflow", "data_id": "action_1_result"}'
#near view $DCID storage_data_as_vec_string '{"bucket_id": "workflow", "data_id": "action_2_result"}'
#near view $DCID storage_data_as_vec_u8 '{"bucket_id": "workflow", "data_id": "action_3_result"}'
#near view $DCID storage_data_as_vec_u8 '{"bucket_id": "workflow", "data_id": "action_4_result"}'
#
####### NEW CALLS ######
...
#near call $DCID storage_add_data_as_string '{"bucket_id": "workflow", "data_id": "action_1_result", "data": "This is result from action 1"}' --accountId=$CID
#near call $DCID storage_add_data_as_vec_string '{"bucket_id": "workflow", "data_id": "action_2_result", "data": ["This is result from action 2", "and its stored as", "array of strings"] }' --accountId=$CID
#near call $DCID storage_add_data_vec_u8 '{"bucket_id": "workflow", "data_id": "action_3_result", "data":[1,2,255,0,3,4]}' --accountId=$CID
#near call $DCID storage_add_data_vec_u8 '{"bucket_id": "workflow", "data_id": "action_4_result", "data":[9,8,7,6]}' --accountId=$CID
