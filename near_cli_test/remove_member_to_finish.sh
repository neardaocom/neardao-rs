...
PUUID=$(near call $DCID add_proposal '{"proposal_input" : {"description": "I need NEAR TOKENS, bros.", "tags":["test","first","money"], "description_cid": null}, "tx_input": { "RemoveMember": {"group": "Council", "account_id":"'$CID3'"} }}' --amount $DEPOSIT_ADD_PROPOSAL --gas $TGAS_100 --accountId $CID4 | tail -n1 | tr -d '[:space:]')
...
near call $DCID vote '{"proposal_id":'$PUUID',"vote_kind": 2}' --gas $TGAS_10 --amount $DEPOSIT_VOTE  --accountId $CID3
