        ...
        match instruction {
            Instruction::Statement(s) => {
                let value: Value = match &s.value {
                    ...
                    StatementVal::FnCall(func, args) => eval_fn(func, args, &self.vmap).expect("Fn eval error"),
                };
...
mod test {
    ...
    fn execute_program_with_fn_in_str() {
        ...
        */
        ...
        register_api.set(
            "some_register",
            &Value::String("future is near".into()),
        );
