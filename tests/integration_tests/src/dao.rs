...
use crate::{
    contract_utils::{
        dao::{
            activity::{
                run_activity, trade::ActivityInputTrade1, ActivityInputSkyward1,
                ActivityInputWfAdd1,
            },
            ...
            types::{
                consts::{
                    DAO_TPL_ID_SKYWARD, DAO_TPL_ID_WF_ADD, PROVIDER_TPL_ID_SKYWARD1,
                    PROVIDER_TPL_ID_TRADE1,
                },
...
/// Sending required tokens enables to send near.
