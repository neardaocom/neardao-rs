...
PUUID=$(near call $DCID add_proposal '{"proposal_input" : {"description": "I need NEAR bros.", "tags":["test","first","money"], "transaction": { "Pay": {"amount_near": "10000000000000000000000000", "account_id":"'$CID4'"} }}}' --amount 0.5 --gas 100000000000000 --accountId $CID4 | tail -n1 | tr -d '[:space:]')
