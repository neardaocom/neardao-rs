...
PUUID=$(near call $DCID add_proposal '{"proposal_input" : {"description": "I need NEAR, bros.", "tags":["test","first","money"], "transaction": { "RegularPayment": {"since": 1663184040000000000,"until": 1694720040000000000, "period": "Daily", "amount_near": "1","account_id":"'$CID4'"} }}}' --amount 0.5 --gas 100000000000000 --accountId $CID4 | tail -n1 | tr -d '[:space:]')
